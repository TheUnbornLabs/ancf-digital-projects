...
try{
var A=window.ANCF||{};
function toggle(el){var w=el.querySelector('.why');if(w)w.style.display=(w.style.display==='none')?'block':'none';}
[].slice.call(document.querySelectorAll('#swaps .swap')).forEach(function(el){
...
var QZ=[{a:1,e:'Respectful advocacy critiques ideas and choices, not people\'s identities.'},{a:1,e:'Contempt makes people defend themselves rather than rethink.'}];
