...
var QZ=[{a:1,e:'Most family pressure comes from care and tradition, even when it lands heavily.'},{a:1,e:'It blames no one — it describes patterns, with respect for diversity.'}];
